...
class PreferenceWindow(wx.Frame):
    ...
    def InitUI(self):
        ...
        sizer.Add(marker_label, pos=(6, 0), flag=wx.ALL, border=5)
        sizer.Add(self.marker_choice, pos=(6, 1), flag=wx.ALL, border=5)

        # Scatter color
        scatter_color_label = wx.StaticText(panel, label="Scatter Color:")
        self.scatter_color_picker = wx.ColourPickerCtrl(panel)
        sizer.Add(scatter_color_label, pos=(4, 0), flag=wx.ALL, border=5)
        sizer.Add(self.scatter_color_picker, pos=(4, 1), flag=wx.ALL, border=5)

        # Line width (for line)
        self.line_width_label = wx.StaticText(panel, label="Line Width:")
        self.line_width_spin = wx.SpinCtrl(panel, value="1", min=1, max=10)
        sizer.Add(self.line_width_label, pos=(2, 0), flag=wx.ALL, border=5)
        sizer.Add(self.line_width_spin, pos=(2, 1), flag=wx.ALL, border=5)
        ...
        sizer.Add(self.line_alpha_label, pos=(3, 0), flag=wx.ALL, border=5)
        sizer.Add(self.line_alpha_spin, pos=(3, 1), flag=wx.ALL, border=5)

        # Line color
        line_color_label = wx.StaticText(panel, label="Line Color:")
        self.line_color_picker = wx.ColourPickerCtrl(panel)
        sizer.Add(line_color_label, pos=(5, 0), flag=wx.ALL, border=5)
        sizer.Add(self.line_color_picker, pos=(5, 1), flag=wx.ALL, border=5)

        # Save button
        save_button = wx.Button(panel, label="Save")
        save_button.SetMinSize((110, 40))
        save_button.Bind(wx.EVT_BUTTON, self.OnSave)
        sizer.Add(save_button, pos=(7, 0), span=(1, 2), flag=wx.ALL | wx.ALIGN_CENTER, border=5)
